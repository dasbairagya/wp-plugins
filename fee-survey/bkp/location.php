...
<div>
  ...
  <div>
  <div>
    <label for="mail">Vegan Category:</label>
...
<input id="locationTextField" class="controls" type="text" size="50">
    <!-- <input id="pac-input" class="controls" type="text" placeholder="Search Box"> -->
<div id="map" style="position:initial; margin-left:130px; height:400px;margin-top: 20px; width: 76%;"></div>
                      
<script async defer src="https://maps.googleapis.com/maps/api/js?v=3.27&key=AIzaSyBYwzmTe-P960g7bRYKItyxa2zSLzqc9B8&callback=initMap&libraries=places">
    </script>
               ...
               var input = document.getElementById('locationTextField');
                ...
                if(input){
                          ...
                          google.maps.event.addListener(autocomplete, 'place_changed',
                              function() {
                                  var markerIcon = "https://maps.gstatic.com/mapfiles/ms2/micons/POI.png";
