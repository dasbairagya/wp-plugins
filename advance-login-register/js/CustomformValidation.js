            ...
            // console.log(ajaxurl);
                jQuery.ajax({
                    ...
                    success: function(response)
                    {
                      ...
                      if(response[0]=='fail')
                          {
                            jQuery('#msg-reg').addClass('strong').html(response[1]);
                          }
                        ...
                        {
                          jQuery('#msg-reg').addClass('strong').html('<div class="alert alert-danger" role="alert">'+
                    ...
                    error: function (response) {
                      console.log(response);
                                      jQuery('#msg-reg').addClass('error').html(response);
                                    jQuery("#register-form")[0].reset()
                                    off();
                                }
