...
class PRI{
    ...
    $labels = array(
        'name'               => _x( 'Play Random Image', 'post type general name', 'your-plugin-textdomain' ),
				    ...
				    <div class="modal-dialog">
				      ...
				      <div class="modal-content">
				        <div class="modal-header">
				          ...
				          <h4 class="modal-title">Random Image form your gallery</h4>
				        </div>
				        <div class="modal-body">
				        	<img class="center-block centered-gdb" id="flip-img" src="">
				          <p>Some dynamic text in the modal.</p>
				        </div>
				        <div class="modal-footer">
				         <button type="button" class="btn btn-default" data-dismiss="modal" onClick="window.location.reload()">Do You Wanna Continue? </button>
				        </div>
				      </div>
	...
	wp_enqueue_style ('bootstrap', PRI_URL. 'css/bootstrap.min.css'  );
	wp_enqueue_style ('style', PRI_URL. 'css/style.css'  );
	//wp_enqueue_script( 'jquery', PRI_URL . 'js/jquery.min.js', array(), false, true );
   // wp_enqueue_script( 'my_custom_script', PRI_URL . 'js/script.js', array(), false, true);
	}
